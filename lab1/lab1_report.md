...
2. Подключаемся к ней по ssh, устанавливаем ansible.![img](step2.png)
...
8. Заполним соответствующие поля: MTU 1420, ListenPort узнаём командой вывода файла /etc/wireguard/wg0.conf на сервере, ключи будут сгененрированы автоматически.![img](step8.png)
